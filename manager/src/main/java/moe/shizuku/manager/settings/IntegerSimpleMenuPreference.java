...
public class IntegerSimpleMenuPreference extends Preference {
    ...
    public IntegerSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        int popupStyle = a.getResourceId(R.styleable.SimpleMenuPreference_android_popupMenuStyle, 0);
        int popupTheme = a.getResourceId(R.styleable.SimpleMenuPreference_android_popupTheme, 0);
        ...
        mPopupWindow = new SimpleMenuPopupWindow(popupContext,
                attrs, R.styleable.SimpleMenuPreference_android_popupMenuStyle, popupStyle);
    ...
    public IntegerSimpleMenuPreference(Context context, AttributeSet attrs, int defStyleAttr) {
        this(context, attrs, defStyleAttr, androidx.preference.R.attr.preferenceStyle);
    }
